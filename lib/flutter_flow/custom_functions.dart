...
String printListOfValuesString(List<String> values) {
  return values.map((i) => i.toString()).join(" , ");
}
...
String getLanguageCode(
  List<LanguageRecord> languageList,
  String selectedLanguage,
) {
  String code = 'en';
  for (int i = 0; i < languageList.length; i++) {
    if (languageList[i].lang!.compareTo(selectedLanguage) == 0) {
      code = languageList[i].langCode!;
    }
  }
  return code;
}
